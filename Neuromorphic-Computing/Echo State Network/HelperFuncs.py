...
def GetLinuxDataPath():
	# **************************************************************************
	# check the special path first
	# **************************************************************************
	SpecialPath	= join("/opt", "Datasets")
	if isdir(SpecialPath):
...
def _GetDataPath():
	...
	if (Platform == "linux2") or (Platform == "linux"):
		# get the home path
		DataPath    = GetLinuxDataPath()

	elif Platform == "win32":
		DataPath    = GetWinDataPath()

	elif Platform == "darwin":
		DataPath    = GetMacOSDataPath()
...
def GetDataPath(DatasetName=None):
	...
	DataPath = os.path.abspath(os.path.join(os.path.dirname(__file__), r"C:\Users\Jaxba\PycharmProjects\Neuromorphic Computing\Datasets"))
